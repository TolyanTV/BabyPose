...
import sys
sys.path.append("C:/Users/User/Desktop/TRP/MICCAI20_SiamParseNet")  # todo set path to your code directory
import warnings
...
from SPN.SPNet import SemiSPNet, SPNet, resnet_feature_layers
...
TOPK = 20
MAX_EPOCH = 40
root_dir = 'C:/Users/User/Desktop/TRP/MICCAI20_SiamParseNet/res3'  # todo the path to save training results
data_dir = "C:/Users/User/Desktop/TRP/Youtube-Infant-Body-Parsing"  # todo the path to training data
GPU = "0"
T = 0.4
...
RESTORE_MATNET_FROM = "C:/Users/User/Desktop/TRP/MICCAI20_SiamParseNet/MS_DeepLab_resnet_pretrained_COCO_init.pth"
RESTORE_SEGNET_FROM = "C:/Users/User/Desktop/TRP/MICCAI20_SiamParseNet/MS_DeepLab_resnet_pretrained_COCO_init.pth"
RESTORE_SPNET_FROM = "C:/Users/User/Desktop/TRP/MICCAI20_SiamParseNet/MS_DeepLab_resnet_pretrained_COCO_init.pth"
...
def get_arguments():
    ...
    parser.add_argument("--is-training", action="store_true",
                        help="Run in training mode (unfrozen BN). Default is False (frozen BN / eval).")
...
def main():
    ...
    model = SPNet(h=int(h / 8), w=int(w / 8),
                      K=args.topK,
    ...
    if args.is_training:
        ...
        # Frozen BN / evaluation mode
        for name, param in model.named_parameters():
            if 'bn' in name:
                param.requires_grad = False
        print("Freezing BN layers (eval mode)")
        optimizer = optim.SGD(
            [{'params': get_1x_lr_params(model),  'lr': args.learning_rate},
            {'params': get_10x_lr_params(model), 'lr': 10*args.learning_rate}],
            lr=args.learning_rate,
            momentum=args.momentum,
            weight_decay=args.weight_decay
    ...
    trainloader = data.DataLoader(SegTrainSemi(data_dir="C:/Users/User/Desktop/TRP/Youtube-Infant-Body-Parsing",
    ...
    while actual_step < args.final_step:
        ...
        for i_iter, batch in enumerate(trainloader):
            ...
            #tr_type = np.random.choice([1, 1, 1], p=[p_0, p_1, p_2])
            tr_type = 2
            ...
            src_imgs, tar_imgs, src_lbls, tar_lbls, src_name, tar_name = batch
            ...
            if actual_step % args.print_freq == 0:
                print('iter: [{0}]{1}/{2}\t'
                      ...
                      'tr_type {tr_type} seg_acc {seg_acc:.3f} mat_acc {mat_acc:.3f} seg_mat_acc {seg_mat_acc:.3f}\n'
                    .format(
